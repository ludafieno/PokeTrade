...
# Image URL pattern or local file — adjust to match your image setup
def get_sprite_url(poke_id):
    return f"https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/{poke_id}.png"


# Load them in
for i, name in enumerate(gen1_pokemon, start=1):
    p, _ = Pokemon.objects.update_or_create(
        poke_id=i,
        defaults={
            "name": name,
            "sprite": get_sprite_url(i),
        }
    )

print("✅ Loaded Gen 1 Pokémon!")
